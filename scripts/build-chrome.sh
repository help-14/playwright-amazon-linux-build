...
yum install -y \
  git redhat-lsb-core python bzip2 tar pkgconfig atk-devel \
  ...
  libgnome-keyring-devel libjpeg-devel libstdc++.i686 \
  ...
  zlib.i686 httpd mod_ssl php php-cli python-psutil wdiff --enablerepo=epel --setopt=protected_multilib=false
